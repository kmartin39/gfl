...
function buildLabelContent() {
  ...
  return {
    ...
    photoUrl: imgSrc === 'photo' ? (selectedPhotoIcon?.path ?? null) : null,
    photoRotation: imgSrc === 'photo' ? photoRotation : 0,
    photoFlipH: imgSrc === 'photo' && photoFlipH,
    photoFlipV: imgSrc === 'photo' && photoFlipV,
    iconPosition,
